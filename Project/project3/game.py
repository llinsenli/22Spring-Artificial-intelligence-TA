...
class Grid:
    ...
    def __init__(self, width, height, initialValue=False, bitRepresentation=None):
        ...
        self.width = width
        self.height = height
        self.data = [[initialValue for y in range( # Data is accessed via grid[x][y] where (x,y)
            height)] for x in range(width)]        # A 2-dimensional array of objects backed by a list of lists
